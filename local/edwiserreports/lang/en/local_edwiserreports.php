...
$string['fullname'] = "User Name";   // Full Name
...
$string['enrolledon'] = "First Name";  //Enrolled Type
$string['enrolltype'] = "Last Name";  //Enrolment On
